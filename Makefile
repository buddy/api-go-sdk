...
test_dev:
	...
	go clean -testcache
	TF_LOG=${TF_LOG} BUDDY_TOKEN=${BUDDY_TOKEN} BUDDY_GH_TOKEN=${BUDDY_GH_TOKEN} BUDDY_GH_PROJECT=${BUDDY_GH_PROJECT} BUDDY_BASE_URL=https://api.tsd.com BUDDY_INSECURE=true go test $(TEST) -v ${TESTNAME} -timeout 60m
