...
func (s *IntegrationService) Create(workspaceDomain string, ops *IntegrationOps) (*Integration, *http.Response, error) {
	var i *Integration
	resp, err := s.client.Create(s.client.NewUrlPath("/workspaces/%s/integrations", workspaceDomain), &ops, nil, &i)
	return i, resp, err
}

func (s *IntegrationService) Delete(workspaceDomain string, hashId string) (*http.Response, error) {
	return s.client.Delete(s.client.NewUrlPath("/workspaces/%s/integrations/%s", workspaceDomain, hashId), nil, nil)
}

func (s *IntegrationService) Update(workspaceDomain string, hashId string, ops *IntegrationOps) (*Integration, *http.Response, error) {
	var i *Integration
	resp, err := s.client.Patch(s.client.NewUrlPath("/workspaces/%s/integrations/%s", workspaceDomain, hashId), &ops, nil, &i)
	return i, resp, err
}

func (s *IntegrationService) Get(workspaceDomain string, hashId string) (*Integration, *http.Response, error) {
	var i *Integration
	resp, err := s.client.Get(s.client.NewUrlPath("/workspaces/%s/integrations/%s", workspaceDomain, hashId), &i, nil)
	return i, resp, err
}
